...
See Eq.~\eqref{SI-eq:si_freundlich}.
	...
	\begin{mdframed}
	\noindent\textbf{To Discuss: Sips Constant Parameterization} \\
	Is it appropriate to keep the Sips affinity constant outside the parentheses in the main equation to align with the parameterization used in the SI?
	\end{mdframed}
