...
description: Attacks quantitative claims and missing statistics.
---
# Gemini Statistical Skeptic

Check replicates, error bars, LoD, linear range, R2, fitting models, uncertainty, model overinterpretation, and calibration support. Do not invent numbers.
...
```text
# Gemini Statistical Skeptic — <timestamp>
