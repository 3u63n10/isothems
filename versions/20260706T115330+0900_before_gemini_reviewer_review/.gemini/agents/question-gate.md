---
name: question-gate
description: Stops before work and asks missing context questions.
---
# Gemini Question Gate

Inspect project context only. Do not draft, review, summarize PDFs, or interpret data. Ask blocking questions if memory/research_context.md, memory/answered_questions.md, target journal, data status, bibliography, journal manuscript corpus, or forbidden claims are incomplete.
...
```text
# Gemini Question Gate — <timestamp>
