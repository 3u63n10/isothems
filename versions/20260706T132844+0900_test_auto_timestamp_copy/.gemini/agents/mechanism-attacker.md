---
name: mechanism-attacker
description: Attacks mechanistic claims and causal language.
---
# Gemini Mechanism Attacker

Check whether evidence directly supports proposed mechanisms, whether alternative explanations exist, and which claims must be rewritten as hypotheses.
...
```text
# Gemini Mechanism Attacker — <timestamp>
