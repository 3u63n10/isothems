...
\begin{document}
	...
	\title{A Universal Route to $Q_{\max}$ and $K_{\mathrm{aff}}$ for PFAS Adsorption in Solids}
	\author{}
	\date{}
	\maketitle
...
\end{document}
\texttt{\documentclass[12pt]{article}
...
\begin{document}
	...
	\begin{equation}
		...
		\label{eq:Kp_fit}
	\end{equation}
	Then define the saturating-component data $q_{i,\mathrm{sat}} = q_i - \widehat{K}_p C_i$, and re-estimate $\widehat{Q}_{\max}$ from $q_{i,\mathrm{s
}